...
\item Pour découpler une machine virtuelle à partir du logiciel, Zhang et al.
[ADNC + 12] ont élaboré un framework pour le déploiement des applications dans le cloud, qui vise à réduire le temps et les coûts liés au déploiement. La
